...
public class ServletUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (status != 0) 
		{
			pw.print("<script>alert('Updated successfully!!');window.location.replace('operation.html');</script>");
		} 
		else 
		{
			pw.print("<script>alert('Updated Unsuccessfull!!');window.location.replace('operation.html');</script>");
	    }
